...
public class Effect : ICloneable
{
    ...
    public Effect(TargetType targetType, IEnumerable<EffectType> effects, IEnumerable<int> lifeamounts = null, ICollection<KeyValuePair<StatusType, int>> statusamount = null, ICollection<KeyValuePair<CharacterStatType, int>> statamount = null)
    {
        Target = targetType;
        ...
        else
        {
            ...
            CharacterStatAmount = new Dictionary<CharacterStatType, int>(statamount);
        }
        ...
        else
        {
            ...
            StatusAmount = new Dictionary<StatusType, int>(statusamount);
        }
    }
